...
| Match lifecycle: FFA/TDM, scoreboard, kill feed, timer, end screen          | M4        | Done for FFA — warmup, clock, frag limit, scoreboard, end screen; TDM is sim-complete but not yet in the lobby; CTF unstarted |
